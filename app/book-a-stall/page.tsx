        ...
        <div className="max-w-2xl w-full">
          ...
          <div className="border-4 border-black p-8 bg-white relative overflow-hidden">
            ...
            <div className="flex items-center mb-8">
              ...
              <div className="px-4 font-display font-black text-xl">COMING SOON</div>
              <div className="h-1 bg-purple-600 flex-grow"></div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
              <div className="border-2 border-black p-4">
                ...
                <div className="flex items-center">
                  ...
                  <p className="font-display">REGISTRATION FORM COMING SOON</p>
                </div>
              </div>
              <div className="border-2 border-black p-4">
                <h3 className="font-display font-black text-xl mb-2">ETA</h3>
                <p className="font-display">MARCH 10, 2025</p>
              </div>
            </div>

            <div className="text-center">
              <p className="font-display text-lg mb-4">We're preparing the stall booking system for you.</p>
