            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
              <div className="border-2 border-black p-4">
                ...
                <div className="flex items-center">
                  ...
                  <p className="font-display">RSVP SYSTEM IN DEVELOPMENT</p>
                </div>
              </div>
              <div className="border-2 border-black p-4">
                <h3 className="font-display font-black text-xl mb-2">ETA</h3>
                <p className="font-display">MARCH 5, 2025</p>
              </div>
            </div>

            <div className="text-center">
              <p className="font-display text-lg mb-4">We're building an awesome RSVP system for you.</p>
