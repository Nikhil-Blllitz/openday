...
// export default function Footer() {
//   return (
//     <footer className="bg-white text-black py-10 font-coolvetica">
//       <div className="max-w-5xl mx-auto px-4 text-center">
//         {/* Social Icons */}
//         <div className="flex justify-center space-x-6 mb-4">
//           <Link href="#" className="text-black hover:text-gray-600 text-2xl">
//             <FaLinkedin />
//           </Link>
//           <Link href="#" className="text-black hover:text-gray-600 text-2xl">
//             <FaXTwitter />
...
//           Cambridge Institute of Technology (CITech), Bengaluru, is a dynamic and innovative hub of education, fostering excellence in engineering, technology,
//         </p>
...
//           <p>© CIT OPEN DAY | <Link href="#" className="hover:underline">Privacy & Policy</Link></p>
//         </div>
//       </div>
//     </footer>
