      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        >
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div>
              <div className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-amber-600 to-yellow-600 mb-2">
                150+
              </div>
        ...
        >
          ...
          <form className="space-y-4">
            <select className="w-full p-3 border border-amber-200 rounded-lg bg-white/90 backdrop-blur-sm focus:ring-2 focus:ring-amber-300 focus:border-transparent text-gray-800 appearance-none cursor-pointer">
